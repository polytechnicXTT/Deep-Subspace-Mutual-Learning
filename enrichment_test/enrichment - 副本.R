...
file_dir = paste0("D:\\PyCharm\\PyCharm_Projects\\DSML\\cluster_result\\GBM\\single_view_res\\", missing_rate, "\\", model, "\\")
...
for (i in 1:126){
  ...
  for (j in 1:epoch-1){
    cluster_name = paste0(cluster_file_dir, j, ".xls")
    print(cluster_name)
  ...
  print("_______________________________________________________________________________")
   ...
   for (j in 1:epoch-1){
     gender_name = paste0(gender_file_dir, j, ".xls")
     print(gender_name)
  ...
  #  for (j in 1:epoch-1){
  #    path_M_name = paste0(path_M_file_dir, j, ".xls")
  #    print(path_M_name)
  ...
  # 
  # for (j in 1:epoch-1){
  #    path_N_name = paste0(path_N_file_dir, j, ".xls")
  #    print(path_N_name)
  ...
  # 
  #  for (j in 1:epoch-1){
  #    path_stage_name = paste0(path_stage_file_dir, j, ".xls")
