...
model_dir = 'D:\PyCharm\PyCharm_Projects\MvSCN\xlsx\KRCCC\Partial_Model\0.3\'+model+'\';
epoch = 20;
C = 3;
save_dir =   63 ;
...
s_c = []
surv=importdata('D:\PyCharm\PyCharm_Projects\MvSCN\data\KRCCC\KIDNEY_Survival.txt');
...
for i = 0:epoch-1
    ...
    s_c(i+1) = silhouette1;
    %disp(s_value);
    outpart1="D:/PyCharm/PyCharm_Projects/MvSCN/han/test_results/KRCCC/partial_res/0.3/"+model+"/"+model+"_param_comb/"+ save_dir +"/txt/kidney_test"+i;
    outpart2=".txt";
