...
model_dir = 'D:\PyCharm\PyCharm_Projects\DSML\partial_model\'+data_name+'\'+missing_rate+'\'+model+'\';
epoch = 20;
C = 3;
...
for i = 0:epoch-1
    ...
    %s_c(i+1) = silhouette1;
    %disp(s_value);
    outpart1="D:/PyCharm/PyCharm_Projects/DSML/cluster_result/"+data_name+"/partial_res/"+missing_rate+"/"+model+"/"+model+"_param_comb/"+ save_dir +"/txt/"+save_file_name+"_test"+i;
    outpart2=".txt";
